 ...
 * Init module
 * @type {Rx}
 */var screen$=_screenViewer2.default.init$([load$,ready$,resize$]);/**
...
screen$.subscribe(function(_ref){var type=_ref.type;// Display info
infoTypeEl.innerHTML=type;});// Listen screen changes
_Rx.Observable.merge(load$,resize$).subscribe(function(width){// Display screen width
